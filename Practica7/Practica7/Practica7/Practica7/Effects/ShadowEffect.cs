...
namespace Practica7.Effects
{
	namespace MyCompany.Forms.PlatformConfiguration.Android
	{
		...
		public static class ShadowEffect
		{
			...
			public static readonly BindableProperty IsShadowedProperty = BindableProperty.CreateAttached("IsShadowed", typeof(bool), typeof(ShadowEffect), false, propertyChanged: OnIsShadowedPropertyChanged);
